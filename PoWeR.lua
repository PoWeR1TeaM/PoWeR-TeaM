...
if text == (Redis:get(ThePoWeR.."PoWeR:Name:Bot") or "بلاك بينك") then
local NamesBot = (Redis:get(ThePoWeR.."PoWeR:Name:Bot") or "بلاك بينك")
local NameBots = {
"ها "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
...
local CmdStart = '*\n↭أهلآ بك في بوت '..(Redis:get(ThePoWeR.."PoWeR:Name:Bot") or "بلاك بينك")..
